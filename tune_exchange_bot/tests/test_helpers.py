...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://open.spotify.com/track/3WYVYoA0Usk0trYlSrGQWR",
            "3WYVYoA0Usk0trYlSrGQWR",
        ),
        (
            "https://open.spotify.com/track/3WYVYoA0Usk0trYlSrGQWR?si=GalDkrGDQj6_uBJV9B3Tww",
            "3WYVYoA0Usk0trYlSrGQWR",
        ),
        ("", None),
    ],
